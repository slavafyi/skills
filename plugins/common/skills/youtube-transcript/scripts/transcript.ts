...
async function main(): Promise<void> {
  ...
  try {
    ...
    const lang = (await listLanguages(videoId, options))
      .find(language => !language.isAutoGenerated)?.languageCode
    const transcript = toTranscriptEntries(await fetchTranscript(videoId, { ...options, lang }))
